...
//this function checks that a field has not been left empty
function validateLocation(fld) {
    var error = "";
  
    if (fld.value.length == 0) {
        fld.style.background = 'Yellow'; 
        error = "No value has been provided for the location field\n"
    } else {
...
//this function checks that the phone number has 11 characters and only contains numbers
//it makes use of the JavaScript replace function to clear out any spacer characters
//it also uses the javaScript isNaN() fucntion to check that only numbers have been entered
